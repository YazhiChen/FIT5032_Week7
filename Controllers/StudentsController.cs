...
namespace FIT5032_Week7.Controllers
{
    ...
    {
        private FIT5032_W7_Models db = new FIT5032_W7_Models();

        // GET: Students
        //Also, make changes to the Index method. Here at the Index, select entries that has only been entered by the
